...
interface ControlledLiveSearchBase {
  service: "apollo";
...
export interface ControlledLiveSearchSuccess
  extends ControlledLiveSearchBase {
  upstreamVerified: true;
}

export interface ControlledLiveSearchFailure
  extends ControlledLiveSearchBase {
...
export type ControlledLiveSearchResult =
  | ControlledLiveSearchSuccess
  | ControlledLiveSearchFailure;
  ...
  if (!upstream.ok) {
    return {
      ...
      upstreamFailure: {
        ...
        retryable: upstream.error.retryable,
      },
      leads: [],
    };
  }
